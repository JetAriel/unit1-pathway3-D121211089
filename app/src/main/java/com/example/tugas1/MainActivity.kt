...
fun MiddlePart() {
    ...
    Column(
        ...
        Text(text = "Jet Ariel", fontSize = 30.sp, modifier = Modifier.padding(top = 16.dp))
        Text(text = "Android UI Desaigner", fontSize = 16.sp, fontWeight = FontWeight.SemiBold, color = Color(0xFF006833), modifier = Modifier.padding(top = 8.dp))
    }
}
    ...
    Tugas1Theme {
        ...
        MiddlePart()
            Column(
                ...
                DataRow(text = "0813444094454", icon = Icons.Default.Call)
                DataRow(text = "@arieljet", icon = Icons.Default.Share)
                DataRow(text = "jetariel@gmail.com", icon = Icons.Default.Email)
            }
        }
    }
}